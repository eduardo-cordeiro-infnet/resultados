<?php
	$this->set_css($this->default_theme_path.'/struct/css/struct.css');
	...
	$this->set_js($this->default_theme_path.'/struct/js/cookies.js');
	$this->set_js($this->default_theme_path.'/struct/js/struct.js');

    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.form.min.js');

	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/struct/js/jquery.printElement.min.js');
...
<?php }
?></div>
<div class="struct" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
